...
public enum PrintGoodsReceiptVariableEnum implements BasePrintEnum<String> {
  ...
  GOODS_RECEIPT_QUANTITY_ORDER("{goods_receipt_quantity_order}", "Đối tác", "Giao hàng nhanh"),
  GOODS_RECEIPT_DELIVERY_NAME("{goods_receipt_delivery_name}", "Số lượng đơn","5"),
