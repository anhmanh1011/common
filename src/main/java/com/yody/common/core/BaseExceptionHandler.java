...
public class BaseExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleNoHandlerFoundException(
    ...
    Result result = setupResult();
    result.setErrors(Arrays.asList(error));
    return new ResponseEntity<Object>(result, new HttpHeaders(), HttpStatus.NOT_FOUND);
  }
  ...
  public ResponseEntity<Object> handleAll(final Exception ex, final WebRequest request) {
    ...
    //
    Result result = setupResult();
    result.setErrors(Arrays.asList("server error"));
    result.setMessage(ex.getLocalizedMessage());
  ...
  protected Result setupResult() {
    ...
    result.setResponse_time(new Timestamp(System.currentTimeMillis()));
    return result;
  }
}
