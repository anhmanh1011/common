...
public class Dates {
  ...
  public static Date toDate(String s, DateTimeEnum format) throws ParseException {
    return toDate(s, format.getValue());
  }
  ...
  public static boolean isValidDate(String value) {
    DateFormat df = new SimpleDateFormat(DateTimeEnum.ddMMyyyHHmmss.getValue());
    try {
      df.parse(value);
      return true;
  ...
  public static String today(DateTimeEnum format) throws ParseException {
